...
const Footer = () => {
  return (
    <footer className="bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-300 pt-16 pb-12 transition-colors duration-200">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-4">Liens Rapides</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-600 dark:text-gray-400 text-sm">Quartier Lansanaya, Commune de Matoto, Conakry, Guinée</span>
              </li>
              <li className="flex items-center">
                <Phone className="w-5 h-5 text-guinea-yellow mr-3 flex-shrink-0" />
                <span className="text-gray-600 dark:text-gray-400 text-sm">+224 611 35 34 56</span>
              </li>
              <li className="flex items-center">
                <Mail className="w-5 h-5 text-guinea-yellow mr-3 flex-shrink-0" />
                <a 
                  href="mailto:contact@thetradingmatrix.com" 
                  className="text-gray-600 dark:text-gray-400 text-sm hover:text-primary dark:hover:text-white transition-colors duration-200"
                >
...
const FooterLink = ({ 
  ...
  <li className={cn(small ? "inline" : "")}>
    <Link
      to={href}
      className={cn(
        "text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors duration-200",
...
const SocialIcon = ({
  ...
  <a
    ...
    className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-800 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:text-white hover:bg-guinea-yellow dark:hover:bg-guinea-yellow transition-colors duration-300"
  >

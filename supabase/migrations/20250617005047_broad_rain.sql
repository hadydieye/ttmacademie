/*
  # Fonctions pour la gestion des messages de chat et événements

  1. Nouvelles fonctions
    - `add_chat_message` - Ajouter un message de chat
    - `get_chat_messages` - Récupérer les messages de chat
    - `count_upcoming_events` - Compter les événements à venir

  2. Sécurité
    - Toutes les fonctions utilisent SECURITY DEFINER pour un accès contrôlé
*/
